...
<body background="../img/result.jpg" style="background-repeat: no-repeat;background-size: cover;">
<div style="width: 65%;float: right">
	...
	<div style="margin: 30px">
		<a class="waves-effect waves-light btn-large" href="/typemaster/punjabi" ><b>&nbsp &nbsp Start Again &nbsp &nbsp </b></a>
	</div>
</div>
